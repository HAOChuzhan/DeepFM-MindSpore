...
class StatsDict():
    ...
    def __init__(self, field_size, dense_dim, slot_dim, skip_id_convert):
        ...
        self.dense_dim = dense_dim # 数值特性13个
        self.slot_dim = slot_dim   # 类别特征36个
        self.skip_id_convert = bool(skip_id_convert)

        self.val_cols = ["val_{}".format(i + 1) for i in range(self.dense_dim)] # val_1 -> val_13
        self.cat_cols = ["cat_{}".format(i + 1) for i in range(self.slot_dim)]  # cat_1 -> cat_36

        self.val_min_dict = {col: 0 for col in self.val_cols} # {"val_1": 0, "val_2": 0 …… }
        self.val_max_dict = {col: 0 for col in self.val_cols} # {"val_1": 0, "val_2": 0 …… }

        self.cat_count_dict = {col: defaultdict(int) for col in self.cat_cols}
        # {"cat_1": dict(0), "cat_2": dict(0), ……}
        self.oov_prefix = "OOV"
        ...
        # cat2id_dict = {"val_1": 0, …, "val_13": 12, "OOVcat_1": 13, ……, "OOVcat_36": 38}
...
def random_split_trans2mindrecord(input_file_path, output_file_path, recommendation_dataset_stats_dict,
    ...
    print("-------------" * 10)
    if len(items_error_size_lineCount)!=0:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", type=str, default="./dataset/", help='The path of the data file')
    ...
    parser.add_argument("--train_line_count", type=int, default=1000000,
    ...
    data_file_path = data_path + "origin_data/train_sub100w_filter.txt"
    ...
    in_file_path = data_path + "origin_data/train_sub100w_filter.txt"
    ...
    random_split_trans2mindrecord(in_file_path, output_path, stats, part_rows=2000000,
                                  ...
                                  test_size=0.2, seed=2020, dense_dim=args.dense_dim, slot_dim=args.slot_dim)
